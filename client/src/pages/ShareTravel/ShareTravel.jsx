    ...
    return(
        ...
        <div className="container shareAcc ">
            <div className="row">
                ...
                <div className="col">
                    <span>
                        <ion-icon size="large" className="iconShare" name="time-outline"></ion-icon>
            ...
            <div className="row">
                <div className="col">
                    ...
                    <span>
                        ...
                        <button className="plus count" onClick={arttır}><strong>+</strong></button>{count}<button className="minus count" onClick={azalt}><strong>-</strong></button>
                    </span>
